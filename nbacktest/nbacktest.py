...
class Trade:
    ...
    def update(self):
        ...
        self.df_positions = self.broker._calc_positions(df_orderbook=self.df_orderbook, last_price=self.broker.last_price)
        self.pnl = self.broker._calc_equity(balance=self.balance, df_positions=self.df_positions)
        self.check_stop()
